...
RSpec.describe "activity_validators/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit activity_validator form" do
    render

    assert_select "form[action=?][method=?]", activity_validator_path(@activity_validator), "post" do
